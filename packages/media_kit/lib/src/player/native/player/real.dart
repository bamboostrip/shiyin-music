  ...
  NativeReferenceHolder.ensureInitialized((references) async {
    ...
    try {
      for (final reference in references) {
        // LOCAL PATCH: Clear any wakeup callback from previous isolate before sending 'quit',
        // preventing libmpv from triggering a deleted NativeCallable during hot restart.
        try {
